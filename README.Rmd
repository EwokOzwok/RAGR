...
3. Open your browser and navigate to the URL provided by Shiny.
...
I can also add a **“Folder Structure”** section with `frontend` / `backend` explanations if you want, which helps new users and contributors understand the project faster.
